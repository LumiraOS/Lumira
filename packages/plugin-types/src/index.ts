...
export type RewardsStatusInput = { walletAddress?: string };
export type RewardsStatus = { items: Array<{ label: string; amount?: string; meta?: Record<string, unknown> }> };

export type RewardsClaimInput = { walletAddress?: string; dryRun?: boolean };
